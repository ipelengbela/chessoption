window.onload = function(){
    ...
    function ipeleng(){
        document.getElementById("ipeleng").innerHTML = "2";
    }
    ...
    function names() {
        var myArray = ["Jordan T", "Micheal M", "Jacob C"," Paul H","Micheal M", "Jacob W", "Eli M", "Tyler N", "Paul R", "Samuel M", "Steve C","Christopher G", "Bruno C", "Lily M","Branden H","Njabulo S","David L","Molly E","Benjamin S"];
